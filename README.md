[<img alt='Meatball Day' src='https://www.daysoftheyear.com/cdn-cgi/image/fit=cover,f=auto,onerror=redirect,width=342,height=155/wp-content/uploads/meatball-day.jpg' width=100 align='right'>](https://www.daysoftheyear.com/days/meatball-day/)
<p align='right'>Today, March 9, is</p>
<p align='right'><b>Meatball Day</b> <em>(via <a href='https://daysoftheyear.com'>Days of the Year</a>)</em></p>
...
* :computer: Currently working on [Shopify Admin API Library for Node](https://github.com/Shopify/shopify-node-api)
* :seedling: Trying to learn PHP
* :card_index_dividers: Side projects: [CarbonStack](https://github.com/carmelal/carbon-footprint-stacking)
